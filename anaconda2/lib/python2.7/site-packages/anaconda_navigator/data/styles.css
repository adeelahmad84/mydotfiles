...
QCheckBox {
  ...
  QCheckBox:indicator {
    height: 16px;
    width: 16px; }
    QCheckBox:indicator:disabled:checked, QCheckBox:indicator:disabled:unchecked {
    ...
    QCheckBox:indicator:checked {
      ...
      QCheckBox:indicator:checked:focus, QCheckBox:indicator:checked:checked:hover {
...
ButtonSearch {
  ...
  ButtonSearch:focus, ButtonSearch:hover {
    image: url('$IMAGE_PATH/icons/close.svg'); }
