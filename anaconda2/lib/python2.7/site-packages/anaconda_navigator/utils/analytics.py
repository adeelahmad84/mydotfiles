...
# Third party imports
from qtpy.QtCore import QObject, QThread, QTimer, Signal, QT_VERSION_STR
...
class _GATracker(object):
    ...
    def setup(self):
        ...
        pyqt_version = (pkg_version(pkg='pyqt5', name='root') or
                        pkg_version(pkg='pyqt4', name='root') or
                        pkg_version(pkg='pyqt', name='root'))
        ...
        self.info = {'python': python_version, 'language': self.get_language(),
                     'os': operating_system, 'version': app_version,
                     'platform': self.api.conda_platform(),
                     'qt': QT_VERSION_STR, 'pyqt': pyqt_version,
                     'conda': conda_version}
