...
# Local imports
from anaconda_navigator.config import DEV, TEST_CI
from anaconda_navigator.data import GLOBAL_STYLES_PATH, GLOBAL_SASS_STYLES_PATH
from anaconda_navigator.images import IMAGE_PATH
from anaconda_navigator.utils.py3compat import to_text_string, to_binary_string
...
class SassVariables(object):
    ...
    def __init__(self):
        ...
        self.WIDGET_APPLICATION_TOTAL_WIDTH = 160
        self.WIDGET_APPLICATION_TOTAL_HEIGHT = 160
...
def load_style_sheet():
    ...
    # If on development, then use SASS for compiling the source
    if DEV and not TEST_CI:
        import sass
