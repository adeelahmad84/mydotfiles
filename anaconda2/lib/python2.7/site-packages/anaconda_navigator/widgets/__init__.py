...
from qtpy.QtWidgets import (QFrame, QLabel, QPushButton, QToolButton,
                            QComboBox, QWidget, QStackedWidget, QLineEdit,
                            QMenu, QCheckBox, QSizePolicy)

# Local imports
from anaconda_navigator.utils.qthelpers import (update_pointer, add_actions,
                                                create_action)
...
class ButtonEnvironmentOptions(QPushButton):
    """Button used in CSS styling."""
