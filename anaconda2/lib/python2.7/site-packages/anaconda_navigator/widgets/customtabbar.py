...
from qtpy.QtWidgets import (QLabel, QHBoxLayout, QVBoxLayout, QWidget,
                            QSizePolicy)

# Local imports
from anaconda_navigator.widgets import (ButtonToolBase, ButtonLink, StackBody,
...
#                                     Qt.AlignLeft)
    ...
    def add_social(self, text, url=None):
        ...
        button.clicked.connect(lambda v=None, url=url:
    ...
    def refresh(self, button=None, index=None):
        ...
        # Fix tab order
        widgets = self.buttons + self.links
...
def test():  # pragma: no cover
    ...
    widget = TabWidget()
    widget.addTab(QLabel('HELLO 1'), text='Home',
                  icon=QIcon())
    widget.addTab(QLabel('HELLO 2'), text='Add',
                  icon=QIcon())
