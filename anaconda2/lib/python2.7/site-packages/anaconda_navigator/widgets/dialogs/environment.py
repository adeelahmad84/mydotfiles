...
class ImportEnvironmentDialog(DialogBase):
    ...
    def __init__(self, parent=None, environments=None):
        """Import environment from environment specification dialog."""
        super(ImportEnvironmentDialog, self).__init__(parent=parent)
...
class CloneEnvironmentDialog(DialogBase):
...
def test():   # pragma: no cover
    ...
    app = qapplication()
    widget_create = CreateEnvironmentDialog(parent=None,
                                            environments=['root', 'boom'])
    widget_create.show()

    widget_clone = CloneEnvironmentDialog(parent=None)
    widget_clone.show()

    widget_import = ImportEnvironmentDialog(parent=None,
                                            environments=['root', 'boom'])
    widget_import.show()

    widget_remove = RemoveEnvironmentDialog(parent=None, environment='Test')
    widget_remove.show()
