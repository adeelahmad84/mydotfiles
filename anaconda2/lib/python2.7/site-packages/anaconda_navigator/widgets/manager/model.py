...
# Local imports
from anaconda_navigator.utils import get_icon, sort_versions
...
class CondaPackagesModel(QAbstractTableModel):
    ...
    def __init__(self, parent, packages, data):
        ...
        self._palette = {
            ...
            'icon.downgrade.inactive': get_icon(
                'conda_downgrade_inactive.png'),
            ...
            'icon.action.not_installed': get_icon(
                'conda_action_not_installed.png'),
            'icon.action.installed': get_icon('conda_action_installed.png'),
            'icon.action.installed_upgradable': get_icon(
                'conda_action_installed_upgradable.png'),
            ...
            'spacer': get_icon('spacer.png').pixmap(QSize(16, 16))}
