...
# Local imports
from anaconda_navigator.utils.fixtures import tmpfolder, tmpfile  # analysis:ignore
...
class TestCommunityTab:
    @pytest.mark.skipif(PY3, reason="Travis CI Py3 problem. Local works.")  # analysis:ignore
    def test_campaign_uri(self, qtbot):  # analysis:ignore
        ...
        valid_uri = ('http://go.continuum.io/navigator-testing/'
    ...
    def test_bundled_content(self, qtbot, tmpfile):  # analysis:ignore
        ...
        with qtbot.waitSignal(widget.sig_content_loaded, timeout=10000):
            widget.load_content()
